...
const RootNavigator = () => {
  return (
    <Stack.Navigator initialRouteName={SCREEN_NAMES.WELCOME}>
      ...
      />
      <Stack.Screen
        name={SCREEN_NAMES.ENROLLMENT}
        component={EnrollmentScreen}
      />
      <Stack.Screen
        name={SCREEN_NAMES.MAIN_APP}
        component={TabNavigator}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name={SCREEN_NAMES.EMAIL_DETAILS}
        component={EmailDetailsScreen}
        options={{ title: 'Email Details' }}
      />
      <Stack.Screen
        name={SCREEN_NAMES.LOGOUT_LOGIN}
        component={LogoutLoginScreen}
        options={{ title: 'Logout / Login' }}
      />
      <Stack.Screen
